...
extern "C" PSI_API
SharedWavefunction mp_plugin(SharedWavefunction ref_wfn, Options& options)
{
    SharedWavefunction mp_plugin = SharedWavefunction(new MP_PLUGIN(ref_wfn, options));
    mp_plugin->compute_energy();
    return ref_wfn;
}
