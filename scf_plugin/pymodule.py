...
# @BEGIN LICENSE
#
# scf_plugin by Psi4 Developer, a plugin to:
#
...
def run_scf_plugin(name, **kwargs):
    ...
    scf_plugin_wfn = psi4.core.plugin('scf_plugin.so', ref_wfn)

    return scf_plugin_wfn


psi4.driver.procedures['energy']['scf_plugin'] = run_scf_plugin
